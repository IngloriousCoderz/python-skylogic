...
root = ET.fromstring('<data><country name="Italy"><rank>42</rank><year>1861</year></country></data>')

print(root[0][1].text) # '1861'
print(ET.dump(root)) # prints the xml + 'None'
...
for element in root.findall('./country/neighbor'): # XPath
